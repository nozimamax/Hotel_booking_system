...
const (
	NotifService_Notification_FullMethodName = "/NotifService/Notification"
)
...
type NotifServiceClient interface {
	Notification(ctx context.Context, in *NotificationReq, opts ...grpc.CallOption) (*VoidNotif, error)
}
...
func (c *notifServiceClient) Notification(ctx context.Context, in *NotificationReq, opts ...grpc.CallOption) (*VoidNotif, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VoidNotif)
	err := c.cc.Invoke(ctx, NotifService_Notification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotifServiceServer interface {
	Notification(context.Context, *NotificationReq) (*VoidNotif, error)
...
func (UnimplementedNotifServiceServer) Notification(context.Context, *NotificationReq) (*VoidNotif, error) {
...
func _NotifService_Notification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NotificationReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotifServiceServer).Notification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotifService_Notification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotifServiceServer).Notification(ctx, req.(*NotificationReq))
	}
...
var NotifService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "NotifService",
	HandlerType: (*NotifServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Notification",
			Handler:    _NotifService_Notification_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protos/Notification-service.proto",
}
